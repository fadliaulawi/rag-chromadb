...
with open('embeddings_openai.json', 'r') as file:
    data = json.load(file)
...
for i in tqdm(df.index):
    ...
    # Gunakan fungsi get_retrieved_documents untuk mendapatkan dokumen yang relevan
...
with open('data/test_data/output2-BioASQ-test-yesno-11b.json', 'w') as outfile: 
